...
Here you can also see that some of the types have different colors. These colors are related to type severity. More information about type severity can be found [here](../../concepts-and-features/julia-type-severity).
