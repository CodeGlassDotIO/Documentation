...
## Recordings
Creating a recording in CodeGlass can be done in two ways. The first is through the [UI](../views/app-instance/application-instance#recording) and the second is through the [CodeGlass Julia Package](../languages/Julia/codeglass-jl#recordings).
